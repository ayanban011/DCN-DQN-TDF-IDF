...
export CUDA_INSTALL_PATH=/cm/shared/apps/cuda65/toolkit/current

# Python include directory. This should contain the file Python.h, among others.
export PYTHON_INCLUDE_PATH=/home/xyongle/.myroot/include/python2.7

# Numpy include directory. This should contain the file arrayobject.h, among others.
export NUMPY_INCLUDE_PATH=/home/xyongle/.myroot/lib/python2.7/site-packages/numpy/core/include/numpy

# ATLAS library directory. This should contain the file libcblas.so, among others.
export ATLAS_LIB_PATH=/home/xyongle/.myroot/lib

# You don't have to change these:
export LD_LIBRARY_PATH=$CUDA_INSTALL_PATH/lib64:/home/xyongle/Enthought/Canopy_64bit/User/lib:$LD_LIBRARY_PATH
export CUDA_SDK_PATH=/home/xyongle/cuda50sdk/sdk/5.0.35
