...
#                print self.layers[errname]['children']
    ...
    def get_options_parser(cls):
        ...
        op.options["inner_size"].default = 227
        op.options["testing_freq"].default = 20
...
#    nr.seed(6)
    ...
    # for m in op.options:print m,
    op, load_dic = IGPUModel.parse_options(op)

    # for m in op.keys():print op[m]
    print 'op  ' * 10
    options = op.options
    for m in options:print options[m].prefixed_letter, options[m].value
    print '***' * 20
   # for m in load_dic:print m,
   # for m in load_dic:print load_dic[m],
